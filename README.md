...
|updateMode|int|升级模式|2：走bugly升级；否则，走服务器升级|
|netType|int|网络类型|1：只在wifi情况下提示升级；2:只在移动网络下提示升级；3：只在有网情况下提示升级|只在走公司服务器升级流程才生效|
|updateStrategy|int|升级策略|1：非强制性升级；2：强制性升级|只在走公司服务器升级流程才生效|
|isBrand|int|是否是品牌定制|0：不是；1：是|只在走公司服务器升级流程才生效|
|newFeature|string|升级信息说明|比如："1.修复bug\n2.升级测试"|只在走公司服务器升级流程才生效|
|title|string|升级标题文本|比如："Github6.0.4"|只在走公司服务器升级流程才生效|
